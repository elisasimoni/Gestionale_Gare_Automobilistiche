<template>
    <body>
    <h1>CAMPIONATI</h1>
    <p align="center"><button id="pulsante" @click="displayChoice=true, isAutoButton=true, isEntry=false" >AUTO DI UNO SPECIFICO CAMPIONATO</button></p>
    <p align="center"><button id="pulsante2" @click="displayChoice=true, isEntry=true, isAutoButton=false" >ENTRY DI UN CAMPIONATO</button></p>
    <template v-if="displayChoice">
     <p align="center"> <select id="selectStyle" v-model="year"  >
      ...
      <input type="text" v-model.trim="nome" placeholder="Search.." ></p>
       <template v-if="isEntry">
         <p align="center"><button @click = "getEntry(nome,year); isEntryDisplay=true, isAuto=false" type="submit"><i class="fa fa-search"></i>CERCA</button></p>
       </template>
    <template v-if="isAutoButton">
      <p align="center"> <button @click = "getAutoCampionato(nome,year); isAuto=true, isEntryDisplay=false" type="submit"><i class="fa fa-search"></i>CERCA</button></p>
    </template>
    </template>
