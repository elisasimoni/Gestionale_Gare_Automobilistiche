<template>
  ...
  <p align="center"><input type="checkbox" id="gare" @click="gare=1; campionati=0; displayYear=true">
  <label for="gare">Visualizzare gare a cui i piloti di una determinata nazione partecipano</label><br>
  <input type="checkbox" id="campionati" @click="campionati=1; gare=0; displayYear=true">
  <label for="campionati">Visualizzare campionati a cui i piloti di una determinata nazione partecipano</label><br></p>
  ...
  <p align="center">Inserire codice fiscale</p>
  ...
  <template v-if="isCF">
   <tr  v-for="cf in pilotCF" :key="cf.CF"  >
      <td v-if="cf.CF == CF">
        <h2>Campionati del pilota {{cf.Surname}} {{cf.Name}}</h2>
      </td>
    </tr>
